...
main = do
  ...
  playIO (InWindow "Grab Some Pellets, Friend" (round windowWidth,round windowHeight) (0,0)) black 30 world renderPelletWorld handlePelletWorld (gameplay windowWidth windowHeight)
